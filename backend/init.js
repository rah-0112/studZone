    ...
    try {
        db.query(`
            begin;
                ...
                create table if not exists parent(p_id varchar(6) primary key,id varchar(6),email_id varchar(30),name varchar(3),relationship varchar(6),foreign key(id) references student(id));
