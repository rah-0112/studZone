...
const Academics = () => {
    ...
    const [sem, setSem] = useState([
        {
            ...
            current: true,
            table: (
                <Table sem_no={1} setRefresh={setRefresh} refresh={refresh} />
            ),
        },
        {
            sem: "2",
            current: false,
            table: (
                <Table sem_no={2} setRefresh={setRefresh} refresh={refresh} />
            ),
        },
        {
            sem: "3",
            current: false,
            table: (
                <Table sem_no={3} setRefresh={setRefresh} refresh={refresh} />
            ),
        },
        {
            sem: "4",
            current: false,
            table: (
                <Table sem_no={4} setRefresh={setRefresh} refresh={refresh} />
            ),
        },
        {
            sem: "5",
            current: false,
            table: (
                <Table sem_no={5} setRefresh={setRefresh} refresh={refresh} />
            ),
        },
        {
            sem: "6",
            current: false,
            table: (
                <Table sem_no={6} setRefresh={setRefresh} refresh={refresh} />
            ),
        },
        {
            sem: "7",
            current: false,
            table: (
                <Table sem_no={7} setRefresh={setRefresh} refresh={refresh} />
            ),
        },
        {
            sem: "8",
            current: false,
            table: (
                <Table sem_no={8} setRefresh={setRefresh} refresh={refresh} />
            ),
        },
    ]);
    ...
    return (
        <div className="flex items-center lg:justify-start justify-center w-full h-[91vh] mt-0.5 flex-col">
            <button
