...
import StudentAchievements from "../sections/StudentsAchievements";
import ArrearStudents from "../sections/ArrearStudents";
    ...
    return (
        <>
            ...
            >
                ...
                {openTab === -1 ? (
                    <div className="w-full grid place-items-center h-[91vh] pl-7 pr-7 mt-0.5 md:pl-20 md:pr-20 lg:pl-32 lg:pr-32  font-pop text-2xl font-bold tracking-wider leading-loose text-transparent bg-clip-text bg-gradient-to-r from-slate-500 to-slate-900">
                        <div className="w-full md:w-2/3 flex flex-row text-center justify-center items-center">
                            Welcome to studZone Staff
                            <BriefcaseIcon className="h-7 w-7 text-slate-600 mx-1" />
